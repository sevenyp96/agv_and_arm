...
quaternions[0] = tf::createQuaternionMsgFromRollPitchYaw(0, 0, 0.515);
quaternions[1] = tf::createQuaternionMsgFromRollPitchYaw(0, 0, -1.006);
quaternions[2] = tf::createQuaternionMsgFromRollPitchYaw(0, 0, 3.137);
